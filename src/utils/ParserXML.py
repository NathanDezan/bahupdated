                ...
                if child.tag == '{http://www.w3.org/2005/Atom}author':
                    for author_child in child:
                        if author_child.tag == '{http://www.w3.org/2005/Atom}name':
                            template['author'].append(author_child.text)
        return template
...
<feed xmlns="http://www.w3.org/2005/Atom">
  ...
  <opensearch:totalResults xmlns:opensearch="http://a9.com/-/spec/opensearch/1.1/">207101</opensearch:totalResults>
